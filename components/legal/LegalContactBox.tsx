      ...
      {contactPage && (
        <div className="mt-6">
          ...
          <p className="mb-3 text-gray-700">
            Can't find what you're looking for? Visit our Contact page and we'll
            be happy to assist you.
          </p>

          <Link
            href={contactPage}
            className="inline-flex rounded-full bg-blue-600 px-5 py-2.5 font-medium text-white transition hover:bg-blue-700"
          >
            Contact Us
          </Link>
