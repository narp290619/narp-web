export const faqData = [
  ...
  },
  {
    ...
    answer:
      "Yes. Payments are processed securely, and customers can track bookings, reviews, and transaction history directly within the app.",
  },
  {
    question: "Where is NARP available?",
    answer:
      "NARP is designed for the Philippines and continues to expand its network of verified freelancers across the country.",
  },
];